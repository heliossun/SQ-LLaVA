deepspeed train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/projector/sqllava-spt4v-v1.7-pretrain-ViT-LoRAv2-mlp/mm_projector.bin \
    --pretrain_lora  ./checkpoints/projector/sqllava-spt4v-v1.7-pretrain-ViT-LoRAv2-mlp/Vit-lora/adapter_model.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/sqllava-v1.7-7b-lora-gpt4v-vlorav2-sq50 \
    --num_train_epochs 1 \

deepspeed train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/projector/sqllava-spt4v-v1.7-13b-pretrain-mlp/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/sqllava-v1.7-13b-lora-gpt4v-sq50-vloraPTonly \
    --num_train_epochs 1 \
